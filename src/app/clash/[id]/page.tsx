             ...
             <div className="flex-[3] flex flex-col bg-card/50 border border-white/10 rounded-xl min-h-0">
                <Tabs value={consoleTab} onValueChange={setConsoleTab} className="flex-1 flex flex-col min-h-0">
                  ...
                  <div className='flex-1 min-h-0 overflow-y-auto p-4'>
                    <TabsContent value="test-result" className="m-0 h-full overflow-y-auto">
                    ...
                    <TabsContent value="testcases" className="m-0 h-full overflow-y-auto">
                ...
                <div className='flex justify-end p-2 pt-0 border-t border-border/50 gap-2'>
                    <RunButton />
                    <SubmitButton />
                </div>
             </div>
